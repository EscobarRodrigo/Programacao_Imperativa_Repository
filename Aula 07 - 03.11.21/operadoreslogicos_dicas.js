...
// Nos permitem realizar operações matemáticas

10 + 15 // ---> Soma
10 - 15 // ---> Subtração
10 * 15 // ---> Multiplicação
10 / 15 // ---> Divisão
15++    // ---> Incremento de um em um: 15 + 1 (++ não é na frente do número?)
15--    // ---> Decremento de um em um: 15 - 1 (++ não é na frente do número?)
