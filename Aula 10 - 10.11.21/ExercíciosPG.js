let feiraSemanal = ["Couve","Cenoura","Abobrinha","Vagem Holandesa","Batata Doce"];
...
console.log ("-------------------------------");
console.log (incluiPrimeiroUnshift);//contabiliza a qtd de posições
console.log ("");
console.log (feiraSemanal)
console.log("Retornando a feira para visualizar/confirmar as alterações");
